MEMORY
{
    ...
    */
    ...
    ROM : ORIGIN =   0x42000000 + 0x20, LENGTH = 0x400000 - 0x20 - 0x10000
    KVS : ORIGIN =   0x42000000 + 0x20 + (0x400000 - 0x20 - 0x10000), LENGTH = 0x10000
...
SECTIONS
{
  .kvs_section (NOLOAD) : { KEEP(*(.kvs_section)) } > KVS
}